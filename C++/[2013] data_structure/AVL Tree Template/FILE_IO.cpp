...
bool FILE_IO::ReadCommand(char* getLine, char* command, char* firstName, char* lastName, char* phoneNum, char* subKey, char* address){ //Read command from file
	...
	if(!strcmp(arg[0],"INSERT")){ //Check Insert
		...
		*arg[5]=' ';
		...
		strcpy(firstName, arg[1]);
		strcpy(lastName, arg[2]);
		strcpy(phoneNum, arg[3]);
		strcpy(address, arg[4]);
	...
	if(!strcmp(arg[0], "UPDATENAME")){ //Check Update
		...
		if(arg[6]){
			...
			*arg[6]=' ';
			...
			strcpy(lastName, arg[2]);
			strcpy(subKey, arg[3]);
			strcpy(phoneNum, arg[4]);
			strcpy(address, arg[5]);
	...
	if(!strcmp(arg[0], "UPDATEPHONE")){ //Check Update
		...
		*arg[3]=' ';
		...
		strcpy(command, arg[0]);
		strcpy(phoneNum, arg[1]);
		strcpy(address, arg[2]);
