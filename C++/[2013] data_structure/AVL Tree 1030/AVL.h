...
public:
	...
	bool PrintName(char* lastName, FILE_IO& file); //Print data of all node last-name-matched node
	bool PrintName(char* firstName, char* lastName, FILE_IO& file); //Print name without sub key
	bool PrintName(char* firstName, char* lastName, char* subKey, FILE_IO& file); //Print name
	bool PrintPhone(char* phoneNum, FILE_IO& file); //Print phone
