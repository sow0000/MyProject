///////////////////////////////////////////////////////////////////////////////////////////////////
//TITLE : 8-bit Logical Shift Right
//FILE : LSR8.v
...
//DESCRIPTION : This module defines 8-bit Logical Shift Right
//LAST UPDATE : Nov. 06, 2013
///////////////////////////////////////////////////////////////////////////////////////////////////

module LSR8(d_in,shamt,d_out); //Module of 8-bit Logical Shift Right
	input [7:0] d_in; //input value
	input [1:0] shamt; //shift amount
	output [7:0] d_out; //output value

	mx4 U0_mx4(.y(d_out[7]),.d0(d_in[7]),.d1(1'b0),.d2(1'b0),.d3(1'b0),.s(shamt)); //shift right
	mx4 U1_mx4(.y(d_out[6]),.d0(d_in[6]),.d1(d_in[7]),.d2(1'b0),.d3(1'b0),.s(shamt));
	mx4 U2_mx4(.y(d_out[5]),.d0(d_in[5]),.d1(d_in[6]),.d2(d_in[7]),.d3(1'b0),.s(shamt));
